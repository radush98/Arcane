...
var container = document.querySelector('#description-cover');
console.log(container)
const TWO_PI = Math.PI * 2;

var image
let imageWidth = container.offsetWidth + 'px';
let imageHeight = container.offsetHeight + 'px';
...
function shatter() {
    ...
    for (var i = 0; i < indices.length; i += 3) {
        ...
        var dx = fragment.centroid[0] - clickPosition[0],
            ...
            rx = 30 * sign(dy),
            ry = 90 * -sign(dx),
            delay = d * 0.003 * randomRange(0.7, 0.9);
